...
def optimize(w,b,X,Y,X_test,Y_test,num_iterations,learning_rate,print_cost=False,):  
    ...
    for i in range(num_iterations):  
        ...
        if i % 100 == 0:
            ...
            train_acc = 100 - np.mean(np.abs(Y_prediction_train - Y)) * 100
        ...
        if print_cost and i % 100 == 0:  
            print("cost after iteration %i: %f  train accuracy %f  test_accuracy %f"\
                 % (i, cost,train_acc,test_acc))
...
def model(X_train,Y_train,X_test,Y_test,num_iterations=2000,learning_rate=0.5,print_cost=True):  
    ...
    parameters, grads, costs, train_accs, test_accs = \
        optimize(w,b,X_train,Y_train,X_test,Y_test,num_iterations,learning_rate,print_cost)  
