...
#     val_json_path = '../annotations/MC3_val.json'
    im_dir = '/home/mc16/data/second_round/images_89484'
#     train_json_path = '../annotations/MC3_80k_train.json'
    train_json_path = '../annotations/MC3_80k_train_avg_class.json'
    val_json_path = '../annotations/MC3_80k_val.json'
    classes_path = 'model_data/mc3_classes.txt'
    anchors_path = 'model_data/tiny_yolo_anchors.txt'
    load_pretrained = True
#     weights_path = 'model_data/darknet53.h5'
    weights_path = 'logs/20180727T0709_tiny_adam/ep045-loss7.417-val_loss7.466.h5'
    base_dir = './logs'
...
#     f.close()
    ...
    log_dir = os.path.join(base_dir,"{:%Y%m%dT%H%M}_tiny_".format(now)+opt_string)
    ...
    model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2,load_pretrained=load_pretrained,weights_path=weights_path)
...
#             freeze_body=2,load_pretrained=load_pretrained,weights_path=weights_path) # make sure you know what you freeze
...
#     train_generator = data_generator(im_dir,train_info[:train_num], BATCH_SIZE, input_shape, anchors, num_classes)
#     val_generator = data_generator(im_dir,val_info[:val_num], BATCH_SIZE, input_shape, anchors, num_classes)
...
# def data_generator(im_dir,annotation_lines, batch_size, input_shape, anchors, num_classes):
...
#             image, box = get_random_data(im_dir,annotation_lines[i], input_shape, random=True)
